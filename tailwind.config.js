  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "brand-secondary": "var(--color-brand-secondary)", /* orange-500 */
        "conversion-accent": "var(--color-conversion-accent)", /* emerald-500 */
        "trust-builder": "var(--color-trust-builder)", /* gray-600 */
      ...
      boxShadow: {
        ...
        'high': '0 10px 25px rgba(0, 0, 0, 0.15), 0 4px 6px rgba(0, 0, 0, 0.1)',
        'premium': '0 8px 32px rgba(0, 0, 0, 0.12), 0 2px 16px rgba(0, 0, 0, 0.08)',
      },
      animation: {
